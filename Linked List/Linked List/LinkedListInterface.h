...
public:
	...
	virtual bool insertHead(Teml value) = 0;

	/** Insert Node at end of linked list (no duplicates) */
	virtual bool insertTail(Teml value) = 0;

	/** Insert node after matchNode (no duplicates) */
	virtual bool insertAfter(Teml matchNode, Teml node) = 0;

	/** Remove Node from linked list */
	virtual bool remove(Teml value) = 0;
